...
//import the array of images created 
...
class Images extends React.Component {
  ...
  handleClick = (event) => {
    ...
    let allPictures = document.getElementsByClassName("image-blank"); //"image-blank" represents the back of the cards
  ...
  render() {
    return (
      <div className="images">
        {images
          .sort(() => Math.random() - 0.5) //use sort() method to randomize the card positions and apply math.random method 
          .map((element) => {
            return (
              <div
